...
class Chap2_partition {
    ...
    partition(node: LinkedListNode | null, x: number): LinkedListNode | null {

        let beforeStart: LinkedListNode | null = null;
        let beforeEnd: LinkedListNode | null = null;
        let afterStart: LinkedListNode | null = null;
        let afterEnd: LinkedListNode | null = null;
    ...
    partition2(node: LinkedListNode | null, x: number): LinkedListNode | null {
