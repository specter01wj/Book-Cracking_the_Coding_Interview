...
output += "Adopt dog: " + shelter3.dequeueDog().toString() + "<br>";
output += "Adopt dog: " + shelter3.dequeueDog().toString() + "<br>";
output += "Adopt dog: " + shelter3.dequeueDog().toString() + "<br><br>";
...
output += "Adopt cat: " + shelter4.dequeueCat().toString() + "<br>";
output += "Adopt cat: " + shelter4.dequeueCat().toString() + "<br>";
output += "Adopt cat: " + shelter4.dequeueCat().toString() + "<br><br>";
